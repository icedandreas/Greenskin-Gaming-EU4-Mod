...
NDefines.NDiplomacy.INFILTRATE_ADMINISTRATION_DURATION = 1
...
NDefines.NCountry.RAZE_TECH_POWER_DECREASE = 0.00
...
NDefines.NMilitary.DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.6
...
NDefines.NAI.AI_WANT_ACCEPT_CULTURES = 800	--How much the AI values having much development in accepted cultures.
...
NDefines.NAI.ARMY_DISTANCE_SCORE_IMPACT	= 2.0	--Army <-> province distance impact on province evaluation
...
--NDefines.NAI.MAX_TASKS_NEW_REGION_ASSIGN_ALGORITHM = 0 Needs to be tested.
--NDefines.NAI.MAX_ARMIES_NEW_REGION_ASSIGN_ALGORITHM = 0	Needs to be tested.
...
NDefines.NAI.PEACE_TERMS_TRADE_POWER_BASE_MULT =0.1
NDefines.NAI.PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.1	
NDefines.NAI.PEACE_TERMS_TRANSFER_VASSALS_BASE_MULT	= 3
NDefines.NAI.PEACE_TERMS_RELEASE_ANNEXED_BASE_MULT = 0.01	
NDefines.NAI.PEACE_TERMS_ANNUL_TREATIES_BASE_MULT =	0.1
...
NDefines.NAI.PEACE_TERMS_PROVINCE_NO_INTEREST_MULT = 0.001  --AI desire for a province is multiplied by this if it is not on their conquest list.
...
NDefines.NAI.PEACE_TERMS_PROVINCE_OVEREXTENSION_MAX_MULT = 3.0
NDefines.NAI.PEACE_TERMS_TRIBUTARY_BASE_MULT = 1
NDefines.NAI.DIPLOMATIC_ACTION_KNOWLEDGE_SHARING_ACCEPTANCE_MULT = 5.5
...
NDefines.NAIEconomy.STATE_MAINTENANCE_FRACTION = 0.15
